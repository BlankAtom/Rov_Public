...
#define UpDown_Normal_Value 0x80
...
{
    maxLength = 20;
    quint8* command = new quint8[maxLength]{
        0xAA,                       0x55,                   0x10,
        Deep_Lock,                  Direction_Lock,
        Forwardback_Normal_Value,   LeftRight_Normal_Value,
        UpDown_Normal_Value,        Spin_Normal_Value,
        Speed_None,                 Light_Normal,
        Camera_Normal,              Cloud_Normal,
        Manipulator_Normal,         0x00,
        Draw_Normal,                0x00,
        0x00,                       Start_Stop_Normal
    };
    this->command = new quint8[maxLength];
    this->defaCommand = new quint8[maxLength];
    memcpy(this->command, command, maxLength) ;
    memcpy(this->defaCommand, command, maxLength) ;
